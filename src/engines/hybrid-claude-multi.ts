...
const updatedFile = originalFile.replace(
  /const systemPrompt = `you are throp\. degen crypto twitter's most unhinged shitposter.*?be the most insufferable crypto degen who somehow makes normies feel stupid while accidentally teaching them about defi/s,
  enhancedPersonality
);
