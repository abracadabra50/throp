...
export class PerplexityChaosEngine extends PerplexityEngine {
     ...
     */
    async generateProactiveTweet(prompt, _context) {
     ...
     */
    async reactToTrend(topic, sentiment) {
        const reactions = {
            bullish: [
 ...
 */
export function createPerplexityChaosEngine() {
    return new PerplexityChaosEngine();
}
//# sourceMappingURL=perplexity-chaos.js.map