/**
 * Throp Orchestrator v3 - Fixed JSON parsing and improved tool handling
 ...
 */
export class ThropOrchestratorV3 {
    anthropic;
    webSearch;
    twitter;
    gecko;
    ...
    async process(input, context) {
        logger.info('Orchestrator V3 processing input', { input: input.substring(0, 100) });
        try {
 ...
 * Factory function
 */
export function createOrchestratorV3() {
    return new ThropOrchestratorV3();
}
//# sourceMappingURL=orchestrator-v3.js.map